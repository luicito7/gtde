                          ...
                          <br>
                            ...
                            <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
                              ...
                              <div class="mb-4">
                                ...
                                <input type="date" class="w-full px-3 py-2 leading-tight text-gray-700 bg-blue-100 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" id="fechanac" wire:model="fechanac">
                              </div>
                            </div>  
                              <div>
                                <div class="flex flex-wrap mb-6 -mx-3">
