            ...
            @foreach($personas as $persona)
                <tr>
                    ...
                    <td class="px-4 py-2 text-xs text-center border">
                        <button wire:click="editar({{$persona->id}})" title="Editar" href="http://www.lapaginaweb.com" class="rounded-lg px-0.3 py-0.3 font-bold bg-blue-500 hover:bg-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                            </svg>
                        </button>
                        <button wire:click="borrar({{$persona->id}})" title="Eliminar" href="http://www.lapaginaweb.com" class="rounded-lg px-0.3 py-0.3 font-bold bg-red-500 hover:bg-red-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg> 
                        </button>
                        
                        <button wire:click="detalles({{$persona->id}})" title="Detalles" href="http://www.lapaginaweb.com" class="rounded-lg px-0.3 py-0.3 font-bold bg-green-500 hover:bg-green-600">
