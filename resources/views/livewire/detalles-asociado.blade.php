                    ...
                    <div class="px-4 pt-5 pb-4 bg-yellow-50 sm:p-6 sm:pb-4" >
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3 md:w-1/2 md:mb-0">
                              ...
                              {{-- @error('dni') <p class="text-sm text-red-500">{{ $message }}</p> @enderror  --}}
                            </div>
                            ...
                            <div class="w-full px-3 mb-6 md:w-1/2">
                              ...
                              <div>
                                ...
                                UBICACION</label>
                                <output class="block w-full px-4 py-3 leading-tight text-gray-700 bg-blue-100 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" id="ubicacion" type="texto" wire:model="ubicacion">
                                </div>
                              </div>
                           ...
                           <div class="flex flex-wrap mb-6 -mx-3">
                             ...
                             <div class="w-full px-3 md:w-1/2 md:mb-0">
                               ...
                               <output class="block w-full px-4 py-3 leading-tight text-gray-700 bg-blue-100 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" id="numpadron" type="number" wire:model="numpadron">
                             </div>
                            </div>
